...
class GoodsCategoryModel extends Model
{
    ...
    public function adminCategoryTableTree($currentIds = 0, $tpl = '')
    {
        ...
        foreach ($categories as $item) {
            ...
            $item['str_action'] = '<a href="' . url("GoodsCategory/add", ["parent" => $item['id']]) . '">添加子分类</a>  <a href="' . url("GoodsCategory/edit", ["id" => $item['id']]) . '">' . lang('EDIT') . '</a>  <a class="js-ajax-delete" href="' . url("GoodsCategory/delete", ["id" => $item['id']]) . '">' . lang('DELETE') . '</a> ';
            array_push($newCategories, $item);
        }
